...
const TR: Record<string,Record<string,string>> = {
  ...
  mymemories:{el:"Οι Αναμνήσεις μου",en:"My Memories",ar:"ذكرياتي",es:"Mis Recuerdos",fr:"Mes Souvenirs",de:"Meine Erinnerungen",pt:"As Minhas Memórias",it:"I Miei Ricordi",ru:"Мои воспоминания",tr:"Anılarım",hi:"मेरी यादें",ur:"میری یادیں",zh:"我的回忆",ja:"私の思い出",nl:"Mijn Herinneringen",pl:"Moje Wspomnienia",ro:"Amintirile Mele",bn:"আমার স্মৃতি",id:"Kenangan Saya",sw:"Kumbukumbu Zangu",fil:"My Memories",mr:"माझ्या आठवणी",te:"నా జ్ఞాపకాలు"},
...
function MainApp({ token, profile, onLogout, onExpired, onProfileUpdate, onTokenUpdate, trialEndsAt }: { token: string; profile: Profile; onLogout: () => void; onExpired: () => void; onProfileUpdate: (p: Profile) => void; onTokenUpdate?: (t: string) => void; trialEndsAt?: string | null }) {
  ...
  const navy="#2B3A67",coral="#de5a9e",teal="#4ABEAA",cream="#D4DCE8",gl="#E8EEF5",chatAssistantBg="#FFF7F2",logoPurple="#BEB4CD";
