-- Public read RPCs for offers and promotions (anon + authenticated).
-- Use these on unauthenticated public pages instead of direct table SELECT
-- after public RLS policies were removed (offers_rls_policies.sql, promotions_rls_policies.sql).
